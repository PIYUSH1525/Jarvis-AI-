...
with open("../../OneDrive/Desktop/Jarvis Python 2.0/intents.json") as file:
    data = json.load(file)

model = load_model("chat_model.h5")

with open("../../OneDrive/Desktop/Jarvis Python 2.0/tokenizer.pkl", "rb") as f:
    tokenizer=pickle.load(f)

with open("../../OneDrive/Desktop/Jarvis Python 2.0/label_encoder.pkl", "rb") as encoder_file:
